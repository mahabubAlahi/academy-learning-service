...
"""This package contains the tests for rounds of Test."""
...
from packages.author.skills.assignment_abci.payloads import (
    NewDataPullPayload,
)
...
class BaseTestRoundTest(BaseRoundTestClass):
    """Base test class for Test rounds."""
...
class TestNewDataPullRound(BaseTestRoundTest):
    """Tests for NewDataPullRound."""

    round_class = NewDataPullRound
